...
// Cargar configuración desde archivo separado (no en git)
...
try {
    // Configuración del servidor SMTP de DonDominio (desde config.php)
    $mail->isSMTP();
    ...
    // Remitente (desde config.php)
    $mail->setFrom($config['smtp']['from_email'], $config['smtp']['from_name']);
    
    // Destinatario (desde config.php)
